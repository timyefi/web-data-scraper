...
├── SKILL.md                        # 技能定义与工作流
├── scripts/
│   ├── site_analyzer.py            # 网站结构分析
│   ├── api_discovery.py            # API 端点发现与调用
│   ├── data_extractor.py           # 数据提取（JSON/HTML → CSV/Markdown）
│   └── batch_downloader.py         # 批量文件下载（支持重试、断点续传）
├── references/
│   ├── methodology.md              # 通用抓取方法论
│   ├── anti-detection.md           # 反检测策略指南
│   └── site-examples/              # 各网站操作指南
│       ├── cninfo.md               # 巨潮资讯网
│       ├── chinamoney.md           # 中国货币网
│       ├── statsgov.md             # 国家统计局
│       └── ccgp.md                 # 政府采购网
└── assets/
    └── site-config-template.json   # 新网站配置模板
```
